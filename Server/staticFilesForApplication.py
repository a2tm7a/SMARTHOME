...
def css1(staticFiles) :
    ...
    return static_file(staticFiles , root="/home/pi/Desktop/SMARTHOME/html/Application/css")
...
def img(staticFiles) :
    ...
    return static_file(staticFiles , root="/home/pi/Desktop/SMARTHOME/html/Application/images/portfolio")
...
def img(staticFiles) :
    ...
    return static_file(staticFiles , root="/home/pi/Desktop/SMARTHOME/html/Application/images")

@route('/Application/js/<staticFiles>')

def img(staticFiles) :

    return static_file(staticFiles , root="/home/pi/Desktop/SMARTHOME/html/Application/js")
